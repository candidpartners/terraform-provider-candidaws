...
s3_access_logs_bucket_name = {
  primary = "cfs-base01-services-pg-west-log-bucket" 
  secondary = "cfs-base01-services-pg-east-log-bucket"
}
artifacts_bucket_name         = "cfs-base01-services-pg-artifacts-bucket"
compliance_policy_bucket_name = "cfs-base01-services-pg-mce-policies-bucket"
is_prod_services              = false
private_subnet_name = "private"
is_network_enabled = true
vpc_cidr_block = { 
  primary = "100.84.53.0/24"
  secondary = "100.100.53.0/24"
}
  ...
  primary = { 
    subnets = { 
      private = {
        attach_to_tgw = true
        cidr_blocks = {
          "us-gov-west-1a" = "100.84.53.0/26",
          "us-gov-west-1b" = "100.84.53.64/26",
          "us-gov-west-1c" = "100.84.53.128/26",
  ...
  secondary = { 
    subnets =  { 
      private = {
        attach_to_tgw = true
        cidr_blocks = {
          "us-gov-east-1a" = "100.100.53.0/26",
          "us-gov-east-1b" = "100.100.53.64/26",
          "us-gov-east-1c" = "100.100.53.128/26",
...
dns = {
  hosted_zone_name = "proving-ground.services.awscfs.frb.pvt"
  enable           = true
}
tfstate_bucket_name = "cfs-base01-lz-services-proving-ground-tf-state-bucket"
enable_account_wide_key = false
account_short_name      = "pg"