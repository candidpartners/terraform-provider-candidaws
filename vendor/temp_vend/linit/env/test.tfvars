...
tags = {
  ...
  "Application System CI Name" = "CFS LZ INFRASTRUCTURE - TEST"
  "CI Environment"             = "Test"
}
...
s3_access_logs_bucket_name = {
  primary = "cfs-base01-services-test-west-log-bucket" 
  secondary = "cfs-base01-services-test-east-log-bucket"
}
artifacts_bucket_name         = "cfs-base01-services-test-artifacts-bucket"
compliance_policy_bucket_name = "cfs-base01-services-test-mce-policies-bucket"
is_prod_services              = false
private_subnet_name = "private"
is_network_enabled = true
vpc_cidr_block = { 
  primary = "100.84.54.0/24"
  secondary = "100.100.54.0/24"
}
  ...
  primary = { 
    subnets = { 
      private = {
        attach_to_tgw = true
        cidr_blocks = {
          "us-gov-west-1a" = "100.84.54.0/26",
          "us-gov-west-1b" = "100.84.54.64/26",
          "us-gov-west-1c" = "100.84.54.128/26",
  ...
  secondary = { 
    subnets =  { 
      private = {
        attach_to_tgw = true
        cidr_blocks = {
          "us-gov-east-1a" = "100.100.54.0/26",
          "us-gov-east-1b" = "100.100.54.64/26",
          "us-gov-east-1c" = "100.100.54.128/26",
...
dns = {
  hosted_zone_name = "test.services.awscfs.frb.pvt"
  enable           = true
}
tfstate_bucket_name = "cfs-base01-lz-services-test-tf-state-bucket"
